...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        ImageIcon item_four = new ImageIcon(ClassLoader.getSystemResource("icons/1.png"));
        ...
        JLabel name = new JLabel("Emam Ul Haque Emon");
   ...
   public static void main(String[] args) {
        ...
        try{
            ...
            // Accept Message from client infinitely
            while(true){
                Socket s = skt.accept();
